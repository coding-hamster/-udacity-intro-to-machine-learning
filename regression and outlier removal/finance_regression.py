...
dictionary = pickle.load(open("D://PycharmProjects//untitled//cкрипты Python//udacity_intro_to_machine_learning//final_project//final_project_dataset_modified.pkl", 'rb'))
